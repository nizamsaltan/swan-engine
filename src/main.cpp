...
int main()
{
    ...
    unsigned char *data = stbi_load("../resources/textures/prototype/prototype_512x512_yellow.png", &width, &height, &nrChannels, 0);
    if (data)
    {
...
void processInput(GLFWwindow *window)
{
    ...
    auto cameraSpeed = static_cast<float>(speedUp ? 8 * deltaTime : 3 * deltaTime);
